...
final readonly class InvoiceResource
{
    ...
    {
        return $this->connector->post('/v3/invoices', CreateInvoiceRequest::resolveData($data), InvoiceResponse::class);
    }

    /** @param array<string, mixed> $query */
    public function list(array $query = []): AsaasPaginatedResult
    {
        return $this->connector->paginate('/v3/invoices', $query, InvoiceResponse::class);
    }

    public function find(string $id): AsaasResult
    {
        return $this->connector->get('/v3/invoices/'.$id, [], InvoiceResponse::class);
    }
    ...
    {
        return $this->connector->put('/v3/invoices/'.$id, UpdateInvoiceRequest::resolveData($data), InvoiceResponse::class);
    }

    public function authorize(string $id): AsaasResult
    {
        return $this->connector->post(sprintf('/v3/invoices/%s/authorize', $id), [], InvoiceResponse::class);
    }

    public function cancel(string $id): AsaasResult
    {
        return $this->connector->post(sprintf('/v3/invoices/%s/cancel', $id), [], InvoiceResponse::class);
    }
    ...
    {
        return $this->connector->all('/v3/invoices', $filters, InvoiceResponse::class);
    }
}
