...
final readonly class PaymentResource
{
    ...
    {
        return $this->connector->post('/v3/payments', CreatePaymentRequest::resolveData($data), PaymentResponse::class);
    }

    public function find(string $id): AsaasResult
    {
        return $this->connector->get('/v3/payments/'.$id, [], PaymentResponse::class);
    }

    /** @param array<string, mixed> $query */
    public function list(array $query = []): AsaasPaginatedResult
    {
        return $this->connector->paginate('/v3/payments', $query, PaymentResponse::class);
    }
    ...
    {
        return $this->connector->put('/v3/payments/'.$id, UpdatePaymentRequest::resolveData($data), PaymentResponse::class);
    }

    public function delete(string $id): AsaasResult
    {
        return $this->connector->delete('/v3/payments/'.$id, DeletedResponse::class);
    }
    ...
    {
        return $this->connector->post(sprintf('/v3/payments/%s/refund', $id), RefundPaymentRequest::resolveData($data), PaymentResponse::class);
    }

    public function restore(string $id): AsaasResult
    {
        return $this->connector->post(sprintf('/v3/payments/%s/restore', $id), [], PaymentResponse::class);
    }

    public function captureAuthorized(string $id): AsaasResult
    {
        return $this->connector->post(sprintf('/v3/payments/%s/captureAuthorizedPayment', $id), [], PaymentResponse::class);
    }
    ...
    {
        return $this->connector->post(sprintf('/v3/payments/%s/payWithCreditCard', $id), PayWithCreditCardRequest::resolveData($data), PaymentResponse::class);
    }
    ...
    {
        return $this->connector->post(sprintf('/v3/payments/%s/receiveInCash', $id), ReceivePaymentInCashRequest::resolveData($data), PaymentResponse::class);
    }

    public function undoReceivedInCash(string $id): AsaasResult
    {
        return $this->connector->post(sprintf('/v3/payments/%s/undoReceivedInCash', $id), [], PaymentResponse::class);
    }

    public function status(string $id): AsaasResult
    {
        return $this->connector->get(sprintf('/v3/payments/%s/status', $id), [], PaymentStatusResponse::class);
    }

    public function billingInfo(string $id): AsaasResult
    {
        return $this->connector->get(sprintf('/v3/payments/%s/billingInfo', $id), [], BillingInfoResponse::class);
    }

    public function pixQrCode(string $id): AsaasResult
    {
        return $this->connector->get(sprintf('/v3/payments/%s/pixQrCode', $id), [], PixQrCodeResponse::class);
    }

    public function identificationField(string $id): AsaasResult
    {
        return $this->connector->get(sprintf('/v3/payments/%s/identificationField', $id), [], IdentificationFieldResponse::class);
    }

    public function viewingInfo(string $id): AsaasResult
    {
        return $this->connector->get(sprintf('/v3/payments/%s/viewingInfo', $id), [], ViewingInfoResponse::class);
    }
    ...
    {
        return $this->connector->post('/v3/payments/simulate', SimulatePaymentRequest::resolveData($data), PaymentSimulationResponse::class);
    }

    public function limits(): AsaasResult
    {
        return $this->connector->get('/v3/payments/limits', [], PaymentLimitsResponse::class);
    }
    ...
    {
        return $this->connector->all('/v3/payments', $filters, PaymentResponse::class);
    }
}
